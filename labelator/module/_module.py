...
# disable... just notes for metrics, scVI, etc
...
class MyModule(LightningModule):
    ...
    def __init__(self):
        ...
        self.train_f1 = torchmetrics.classification.F1(num_classes=num_classes, average='macro')
        self.valid_f1 = torchmetrics.classification.F1(tnum_classes=num_classes, average='macro')
