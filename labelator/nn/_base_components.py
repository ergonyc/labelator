# copy of scvi-tools/scvi/model/nn/_base_components.py
...
class FCLayers(nn.Module):
    ...
    set use_batch_norm, use_layer_norm, use_activation to False if linear decoder
...
class Encoder(nn.Module):
    """Encode data of ``n_input`` dimensions into a variational AE latent space of ``n_output`` dimensions.
