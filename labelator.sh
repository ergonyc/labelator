...
train_data="data/scdata/xylena/xyl2_train.h5ad"
query_data="data/scdata/xylena/xyl2_test.h5ad"
adata_output_path='data/scdata/ASAP/LABELATOR2/'
...
artifacts_path='artifacts2/'

# Call the function 
model_path='models2/REPR/scvi'  
...
query_data="data/scdata/xylena/xyl2_query.h5ad"
train_data=""
# Call the function 
model_path='models2/REPR/scvi'  
repr_model_names=("scvi_emb" "scvi_expr" "scvi_expr_pcs")
