...
out_path = data_path / "LBL8r_exp_pca"
in_path = data_path / "LBL8R"

# ## 0. Load training data

train_filen = in_path / XYLENA_TRAIN.replace("_cnt.h5ad", "_exp_nb_out.h5ad")
test_filen = in_path / XYLENA_TEST.replace("_cnt.h5ad", "_exp_nb_out.h5ad")
...
# In[ ]:
pca_model_name = "lbl8r_scviexp_pca"
...
export_ouput_adata(train_ad, train_filen.name.replace("_out.h5ad", "_pca.h5ad"), out_path)
export_ouput_adata(test_ad, test_filen.name.replace("_out.h5ad", "_pca.h5ad"), out_path)
